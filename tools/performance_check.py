...
def main():
    ...
    print("Spectro performance check")
    ...
    try:
        ...
        if frame_fps < 8:
            ...
            print("- Apply Spectro's balanced performance profile, then restart: python tools/apply_performance_profile.py --profile balanced")
            print("- Use Python 3.11 64-bit via Run Spectro.bat, not 32-bit python.exe.")
