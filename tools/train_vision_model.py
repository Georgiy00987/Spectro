...
def main():
    parser = argparse.ArgumentParser(description="Train and export a better Spectro vision model.")
    parser.add_argument("--data", default="datasets/vision_model/data.yaml", help="YOLO data.yaml path.")
    parser.add_argument("--base", default="models/yolov8n.pt", help="YOLO .pt base model or previous best.pt.")
    ...
    parser.add_argument("--name", default="spectro_vision")
