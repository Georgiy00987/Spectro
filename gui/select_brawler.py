...
class SelectBrawler:
    ...
    def __init__(self, data_setter, brawlers):
        ...
        self.app.title(f"Spectro v{spectro_version}")
    ...
    def get_adb_device_for_quick_select(self):
        ...
        if selected_emulator not in emulator_ports:
            ...
            if configured_port_int in (16384, 16416, 16448, 7555):
                selected_emulator = "MuMu"
            elif configured_port_int in (5565, 5575, 5585, 5595, 5605):
                selected_emulator = "BlueStacks"
            elif configured_port_int in (62001, 62025, 62026, 62027, 62028):
                selected_emulator = "Nox"
            elif configured_port_int in (21503, 21513, 21523, 21533, 21543):
                selected_emulator = "MEmu"
            else:
                selected_emulator = "LDPlayer"
        try:
        ...
        port_candidates = [configured_port] + emulator_ports[selected_emulator] + all_emulator_ports
    ...
    def update_images(self, filter_text):
        ...
        def render_batch(start_index=0):
            ...
            for index in range(start_index, min(start_index + 16, len(matches))):
                ...
                label._spectro_image_ref = img_tk
