...
from integrations.discord_notifier import _add_fields, _image_to_file, _ping_content, _title_and_description
...
class DiscordNotifierTest(unittest.TestCase):
    ...
    def test_numpy_screenshot_becomes_discord_file(self):
        ...
        self.assertEqual(url, "attachment://spectro_screenshot.png")
